...
export class ToBusinessOrder extends Order {
    ...
    constructor(packageSize: PackageSize,
                ...
                status?: OrderStatus,
                courier?: Courier) {
        super(FIELD_DICTIONARY_TO_BUSINESS, packageSize, pickUpAddress, pickUpContact, dropOffAddress, dropOffContact,
            readyForPickup, pickUpDate, dropOffDate, commentsForCourier, interCity, customer,
            id, price, priceForCouriers, status, courier);
    ...
    public getDetailsMessageBody(): string {
        ...
        const dropOffDateStr = formatValidationField(this.fieldDict, 'dropOffDate', this.dropOffDate.customerFormatDate());
    ...
    public getValidationMessageSections(): Section[] {
        ...
        if (this.readyForPickup) {
            ...
            //pickUpFields.push(formatChangeButton(this.fieldDict, 'pickUpDate', formatDateWithoutYear(this.pickUpDate)))
        }
